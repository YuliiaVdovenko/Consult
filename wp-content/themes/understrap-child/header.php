...
<div class="hfeed site" id="page">
	...
	<div class="header">
		<ul class="container d-flex flex-wrap justify-content-end">
			<li class="before-header d-inline-flex align-items-center">
				<p class="header-p"><?php echo get_theme_mod('label_email'); ?></p>
				<a href="mailto:<?php echo get_theme_mod('address_email'); ?>" class="link-header">
                    <?php echo get_theme_mod('address_email'); ?>
				</a>
			</li>
			<li class="before-header d-inline-flex align-items-center">
				<p class="header-p"><?php echo get_theme_mod('phone_label'); ?></p>
