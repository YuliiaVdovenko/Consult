    ...
    function customize_contact_register($wp_customize)
    {
        ...
        $wp_customize->add_control(
            new WP_Customize_Control(
                ...
                'description' => __('This is a custom text box for email address'),
    ...
    function customize_social_register($wp_customize)
    {
        ...
        $wp_customize -> add_control(
            new WP_Customize_Control(
                ...
                'blog-title', array(
                'type'=>'text',
                'label' => __('Custom blog name'),
                'section' => 'blog_section',
                'settings' => 'blog-title',
            )));

		$wp_customize -> add_setting('blog-title-post', array(
		'default' => '',
	));
        ...
        $wp_customize -> add_control(
			new WP_Customize_Control(
				$wp_customize,
				'blog-title-post', array(
				'type'=>'text',
				'label' => __('Custom blog name'),
				'section' => 'blog_section',
				'settings' => 'blog-title-post',
			)));
