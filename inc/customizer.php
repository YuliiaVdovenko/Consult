...
if ( ! function_exists( 'customize_contact_register' ) ) {
  function customize_contact_register($wp_customize)
  {
    ...
    $wp_customize->add_setting('label_email', array(
      'default' => '',
    ));
    ...
    $wp_customize->add_setting('address_email', array(
      'default' => '',
    ));
...
if ( ! function_exists( 'customize_social_register' ) ) {
  function customize_social_register($wp_customize)
  {
    $wp_customize->add_section(
      'blog_section', array(
        'title' => __('Blog'),
        'description' => __('Blog settings')
      ));


    $wp_customize->add_setting('blog-back-image');
    $wp_customize->add_control(
...
if ( ! function_exists( 'customize_footer_register' ) ) {
  function customize_footer_register($wp_customize)
  {
    ...
    $wp_customize -> add_setting('menu-title', array(
      'default' => '',
    ));
    ...
    $wp_customize -> add_control(
      new WP_Customize_Control(
        ...
        'menu-title', array(
          'type'=>'text',
          'label' => __('Custom menu name'),
          'section' => 'footer_section',
          'settings' => 'menu-title',
        )));

    $wp_customize -> add_setting('menu-title-2', array(
      'default' => '',
    ));
    ...
    $wp_customize -> add_control(
      new WP_Customize_Control(
        ...
        'menu-title-2', array(
          ...
          'label' => __('Custom menu name'),
          'section' => 'footer_section',
          'settings' => 'menu-title-2',
        )));

    $wp_customize -> add_setting('menu-title-3', array(
      'default' => '',
    ));
    ...
    $wp_customize -> add_setting('theme-name', array(
      'default' => '',
    ));
